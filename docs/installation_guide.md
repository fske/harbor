...
All installers can be downloaded from the **[official release](https://github.com/fske/harbor/releases)** page. 
...
The binary of the installer can be downloaded from the [release](https://github.com/fske/harbor/releases) page. Choose either online or offline installer. Use *tar* command to extract the package.
...
### For HTTPS protocol
1.Enable HTTPS in Harbor by following this [guide](https://github.com/fske/harbor/blob/master/docs/configure_https.md).  
